...
public class OwnerWaitingBookingStrategy implements BookingFetchStrategy {
    private final BookingRepository bookingRepository;

    @Override
    public List<Booking> execute(Long ownerId, Sort sort) {
        return bookingRepository.findAllByOwnerIdAndStatus(ownerId, Status.WAITING, sort);
    }
}
